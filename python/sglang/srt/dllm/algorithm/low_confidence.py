...
class LowConfidence(DllmAlgorithm):
    ...
    def step(
        ...
        # Scalar scatter stays on device; advanced-index assignment would
        # copy a CPU scalar to CUDA and synchronize every denoise step.
        top1_mask.scatter_(1, top1_indices.unsqueeze(1), True)
